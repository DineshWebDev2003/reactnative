...
console.log('🚀 TNHappyKids EAS Update Publisher');
console.log('====================================\n');

function publishUpdate() {
  try {
    console.log('📦 Publishing update with EAS...');
    execSync('eas update --branch production --message "App update"', { stdio: 'inherit' });
    ...
    console.log('\n🔧 Troubleshooting:');
    console.log('1. Make sure you are logged in: eas login');
...
function showHelp() {
  ...
  console.log('  publish    - Publish an EAS update');
